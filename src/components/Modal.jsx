export default function Modal({ children, onConfirm, onClose }) {
    return (
        <div className="absolute z-20 top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 flex bg-stone-400 backdrop-blur-sm bg-opacity-50 items-center justify-center w-screen h-[100dvh]">
